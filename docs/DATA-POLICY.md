...
IWE is delivered in two ways: **distribution** (Git + CLI, for advanced users) and **hosted platform** (one button, for beginners). When you outgrow the platform, you export and own your data.
...
| Deleted on account deletion | No (this is methodology) | No (these are your files) |
...
### Deleting Your Data
In the bot, enter: `Удалить. {Ваше имя}` — this triggers a cascading deletion from all tables.
...
- Anonymized aggregates (DAU/MAU) — not deleted
